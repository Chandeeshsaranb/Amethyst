...
function SecondHalf() {
    ...
    const finestImages = [finest1, finest2, finest3, finest4];
        ...
        <>
            <div style={navaratnaSection}>
                ...
                <div style={navaratnaGrid}>
                    {navaratnaImages.map((img, i) => (
                        <Link
                            to={`/navaratna-product-${i + 1}`}
                            style={linkStyle}
                            key={i}
                        >
                            <div style={navaratnaCard}>
                                <img src={img} alt={`navaratna-${i + 1}`} style={navaratnaImage} />
                ...
                <div style={navaratnaButtonContainer}>
                    <Link to="/navaratna-collection" style={linkStyle}>
            ...
            <div style={finestSection}>
                ...
                <div style={finestGrid}>
                    {finestImages.map((img, i) => (
                        <Link
                            to={`/finest-product-${i + 1}`}
                            style={linkStyle}
                            key={i}
                        >
                            <div style={finestCard}>
                                <img src={img} alt={`finest-${i + 1}`} style={finestImage} />
                ...
                <div style={finestButtonContainer}>
                    <Link to="/finest-collection" style={linkStyle}>
            ...
            <div style={southIndianSection}>
                ...
                <div style={southIndianGrid}>
                    {southIndianImages.map((img, i) => (
                        <Link
                            to={`/south-indian-product-${i + 1}`}
                            style={linkStyle}
                            key={i}
                        >
                            <div style={southIndianCard}>
                                <img src={img} alt={`south-indian-${i + 1}`} style={southIndianImage} />
                ...
                <div style={southIndianButtonContainer}>
                    <Link to="/south-indian-collection" style={linkStyle}>
            ...
            <div style={featuredSection}>
                ...
                <div style={featuredButtonWrap}>
                    <Link to="/featured-victorian-necklace" style={linkStyle}>
                        <div style={featuredButton}>VIEW ALL</div>
                    </Link>
                </div>
            ...
            <div style={flagshipSection}>
                <div style={flagshipCard}>
                    ...
                    <Link to="/flagship-store" style={{ textDecoration: "none" }}>
