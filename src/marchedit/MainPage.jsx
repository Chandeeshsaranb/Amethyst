...
// // // // //   const wrapper    = { flex: 1, padding: "20px 24px", boxSizing: "border-box", background: "#fff" };
// // // // //   const topBar     = { display: "flex", justifyContent: "flex-end", marginBottom: "20px" };
// // // // //   const sortBox    = { border: "1px solid #000", padding: "10px 16px", fontSize: "14px", cursor: "pointer", minWidth: "220px", background: "#fff" };
// // // // //   const grid       = { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "28px 24px" };
// // // // //   const card       = { textAlign: "center", cursor: "pointer" };
// // // // //   const imageWrap  = { width: "100%", aspectRatio: "1 / 1", background: "#f5f5f5", overflow: "hidden", marginBottom: "12px", position: "relative" };
// // // // //   const image      = { width: "100%", height: "100%", objectFit: "cover", display: "block" };
// // // // //   const name       = { fontSize: "16px", color: "#333", marginBottom: "6px" };
// // // // //   const priceStyle = { fontSize: "15px", color: "#666" };
// // // // //   const emptyState = { fontSize: "16px", color: "#666", padding: "40px 0" };
// // // // //   const outOfStockTag = { position: "absolute", top: "10px", right: "10px", background: "#b33939", color: "#fff", padding: "6px 10px", borderRadius: "6px", fontSize: "12px", fontWeight: "700" };

// // // // //   return (
// // // // //     <div style={wrapper}>
// // // // //       <div style={topBar}>
// // // // //         <select style={sortBox} value={sortKey} onChange={(e) => setSortKey(e.target.value)}>
// // // // //           <option value="featured">Featured</option>
// // // // //           <option value="az">Alphabetically, A-Z</option>
// // // // //           <option value="za">Alphabetically, Z-A</option>
// // // // //           <option value="priceLow">Price, low to high</option>
...
// // // // //           {sortedProducts.map((product) => (
// // // // //             <div
// // // // //               key={product.slug}                             // ← was: product.id
// // // // //               style={card}
// // // // //               onClick={() =>
// // // // //                 navigate(`/product/${product.slug}`, { state: product })  // ← was: product.id
// // // // //               }
// // // // //             >
// // // // //               <div style={imageWrap}>
// // // // //                 {product.images.length > 0 && (
...
// // // // // Products are passed in from MarchEdit (already filtered).
// // // // // MainPage only handles sorting and display.
// // // // export default function MainPage({ products = [] }) {
// // // //   const navigate = useNavigate();
// // // //   const [sortKey, setSortKey] = useState("featured");
...
// // // //   const imageWrap     = { width: "100%", aspectRatio: "1 / 1", background: "#f5f5f5", overflow: "hidden", marginBottom: "12px", position: "relative" };
// // // //   const image         = { width: "100%", height: "100%", objectFit: "cover", display: "block" };
// // // //   const nameStyle     = { fontSize: "16px", color: "#333", marginBottom: "6px" };
// // // //   const priceStyle    = { fontSize: "15px", color: "#666" };
// // // //   const emptyState    = { fontSize: "16px", color: "#666", padding: "40px 0" };
// // // //   const outOfStockTag = { position: "absolute", top: "10px", right: "10px", background: "#b33939", color: "#fff", padding: "6px 10px", borderRadius: "6px", fontSize: "12px", fontWeight: "700" };
