...
export default function Products({
  ...
  const handleEditClick = (product) => {
    setFormData({
      slug: product.slug,                          // identifies which product to update
      productName: product.name || "",
      metalType: product.metalType || "",
  ...
  const emptyForm = {
    productName: "", metalType: "", category: "", productDescription: "",
  ...
  return (
    <div style={productsPageWrap}>
      ...
      {showAddProductForm ? (
        <div style={addProductFormCard}>
          <div style={formHeaderRow}>
            <div style={heading}>{formData.slug ? "Edit Product" : "Add Product"}</div>
            <button type="button" style={closeButton} onClick={handleCloseForm}>✕</button>
          </div>
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div style={detailGrid}>
                <div style={fieldWrap}>
                  ...
                  <select name="purity" value={formData.purity || ""} onChange={handleInputChange} style={input}>
                    <option value="">Select purity</option>
                    {(metalPurities[formData.metalType] || []).map((p) => <option key={p} value={p}>{p}</option>)}
                  </select>
                </div>
                <div style={fieldWrap}>
                  <label style={label}>Weight</label>
            ...
            <div style={fieldWrap}>
              <label style={label}>Upload Product Images</label>
              <input ref={fileInputRef} type="file" accept="image/*" multiple onChange={handleImageChange} style={fileInput} />
              <div style={hintText}>Drag the uploaded images to arrange order. The first image will be the main image.</div>
            </div>
            ...
            <button type="submit" style={submitButton}>
              {formData.slug ? "Update Product" : "Save Product"}
            </button>
          </form>
        </div>
                  ...
                  <tr key={product.slug}>
                    ...
                    <td style={tdActions}>
                      <div style={actionsContainer}>
                        ...
                        <button type="button" style={deleteButton} title="Remove" onClick={() => confirmDeleteProduct(product.slug)}>
                          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                            <polyline points="3 6 5 6 21 6"/>
                            <path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/>
